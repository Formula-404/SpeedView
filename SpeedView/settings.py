"""
Django settings for SpeedView project.
...
SECRET_KEY = 'django-insecure-7=0&h2o71kncnbvc(g8r!%j($^z(9=$m%4i5n9u5^!^-xfbp5h'
...
WSGI_APPLICATION = 'SpeedView.wsgi.application'
