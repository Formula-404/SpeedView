...
urlpatterns = [
    ...
    path(
        "api/<int:driver_number>/update/",
        views.api_driver_update,
        name="api_update",
    ),
    path(
        "api/<int:driver_number>/delete/",
        views.api_driver_delete,
        name="api_delete",
    ),
    path(
    ...
    path(
        "<int:driver_number>/",
        views.driver_detail_page,
        name="driver_detail",
    ),
    path(
        "<int:driver_number>/edit/",
        views.edit_driver_page,
        name="edit_page",
    ),
    path(
        "<int:driver_number>/delete/confirm/",
        views.delete_driver_page,
        name="delete_page",
    ),
    ...
    path(
        "api/mobile/",
        views.api_mobile_driver_list,
        name="api_mobile_list",
    ),
    path(
        "api/mobile/create/",
        views.api_mobile_driver_create,
        name="api_mobile_create",
    ),
    path(
        "api/mobile/<int:driver_number>/update/",
        views.api_mobile_driver_update,
        name="api_mobile_update",
    ),
    path(
        "api/mobile/<int:driver_number>/delete/",
        views.api_mobile_driver_delete,
